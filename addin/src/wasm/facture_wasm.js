/* @ts-self-types="./facture_wasm.d.ts" */
 ...
 * @param {string} invoice_json
 * @returns {string}
 */
export function validate_json(invoice_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(invoice_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('facture_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
